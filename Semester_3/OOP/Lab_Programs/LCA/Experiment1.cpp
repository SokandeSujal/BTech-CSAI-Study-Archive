...
public:
    ...
    BankAccount(int acc_id, string acc_type, string acc_name, string cust_address, string cust_contactno, double balance)
    {
        this->acc_id = acc_id;
    ...
    void deposit(double amount)
    {
        ...
        {
            balance += amount;
            cout << "Amount Deposited for account: " << acc_id << " Updated Balance: " << balance << endl;
        }
    }
    ...
    void withdraw(double amount)
    {
        ...
        {
            balance -= amount;
            cout << amount << " Amount withdrawed! Updated Balance: " << balance << endl;
        }
    }
